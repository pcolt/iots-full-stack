...
- 🏗️ step 3: frontend with React using the backend as single-page web application 
- step 3: migrate backend to Google Cloud Functions
- step 3: add React Native mobile app
- step 4: change/add sensor to CO2/other 
